...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Feed Management</h1>
    <div class="text-sm font-semibold lux-purple-text px-3 py-1 rounded-full border border-gray-300 bg-amber-50">
        <i class="fas fa-newspaper mr-1 lux-purple-text"></i> Total: {{ $feeds->total() }} feeds
    </div>
</div>
...
<div class="floating-card mb-6">
    ...
    <div class="p-5">
        <form action="{{ route('staff.feeds.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
    ...
    <div class="overflow-x-auto">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-600 text-lg mb-2 font-semibold">No feeds found</p>
