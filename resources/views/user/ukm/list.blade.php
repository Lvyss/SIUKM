...
<main class="container mx-auto px-4 sm:px-6 lg:px-8 -mt-24">
    <div class="bg-white p-6 rounded-xl shadow-lg">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" id="ukm-grid">
            @foreach($ukms as $ukm)
            {{-- START CARD UKM BARU --}}
            <div class="bg-white rounded-xl shadow-lg overflow-hidden transform hover:shadow-xl hover:scale-[1.02] transition duration-300 ukm-card" data-category="{{ $ukm->category_id }}">
                ...
                <div class="h-36 relative bg-gray-100 flex items-center justify-center">
                    ...
                    <div class="absolute top-full left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 border-4 border-white rounded-full overflow-hidden bg-white shadow-lg z-20 ukm-logo-container transition duration-300">
                        @if($ukm->logo)
                ...
                <div class="pt-16 pb-6 px-4 text-center">
                    ...
                    <p class="text-sm text-gray-500 mb-4 h-12 overflow-hidden line-clamp-2">{{ Str::limit($ukm->description, 80) }}</p>
                    ...
                    <div class="flex flex-col items-center justify-center space-y-1 text-sm text-gray-500 mb-4">
                        ...
                        <div class="flex items-center text-gray-500">
                            ...
                            <span class="text-xs">{{ $ukm->registrations()->where('status', 'approved')->count() }} Anggota</span>
                        </div>
                    </div>
