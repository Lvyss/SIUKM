...
@section('content')
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 -mt-24">
        <div class="bg-white p-6 rounded-xl shadow-lg">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-6" id="events-grid">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden transform hover:scale-[1.02] transition duration-300 event-card"
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <button class="open-event-modal flex-1 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition text-sm font-medium flex items-center justify-center"
