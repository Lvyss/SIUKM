...
<section class="md:mr-[-31px]  md:ml-[-32px] relative bg-cover bg-center text-white text-center shadow-lg mb-8 h-48 overflow-hidden" 
         style="background-image: url('/img/header.png');">
    
    <div class="relative z-10 h-full flex flex-col justify-center">
        <h1 class="text-3xl tracking-wider">Events</h1>
        <p class="mt-2 text-sm text-gray-200">Kegiatan Terbaru</p>
    </div>
</section>
...
<main class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6" id="events-grid">
            @foreach ($events as $event)
                <div class="bg-white rounded-md shadow-md overflow-hidden transform hover:scale-[1.02] transition duration-300 event-card h-full flex flex-col"
                    ...
                    <div class="h-44 md:h-60 bg-gray-200 flex items-center justify-center text-gray-400 overflow-hidden relative">
                        @if ($event->poster_image)
                            <img src="{{ $event->poster_image }}" alt="{{ $event->title }}"
                                class="w-full h-full object-cover">
                        @else
                            <div class="w-full h-full bg-gradient-to-br from-orange-500 to-purple-600 flex items-center justify-center">
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        ...
                        <div class="mt-auto pt-2">
                            <div class="flex space-x-2">
                                <button class="open-event-modal flex-1 bg-gray-600 text-white py-2 rounded-lg hover:bg-orange-700 transition text-sm font-medium flex items-center justify-center"
        ...
        <div class="text-center py-12 hidden" id="no-filtered-events">
            ...
            <button class="mt-4 px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors category-filter"
                data-category="all">
